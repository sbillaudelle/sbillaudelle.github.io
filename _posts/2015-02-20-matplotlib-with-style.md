...
My `matplotlibrc` is hostet at GitHub: [https://github.com/sbillaudelle/matplotlibrc](https://github.com/sbillaudelle/matplotlibrc). I will try to keep it up to date and would love to get some feedback from you!
